...
LOCK TABLES `EntryType` WRITE;
/*!40000 ALTER TABLE `EntryType` DISABLE KEYS */;
INSERT INTO `EntryType` VALUES (1,'AngularJS'),(2,'Bootstrap'),(3,'CSS'),(4,'Font Awesome'),(5,'Java'),(6,'NCP'),(7,'TLX');
/*!40000 ALTER TABLE `EntryType` ENABLE KEYS */;
UNLOCK TABLES;
